...
async function uploadAndInsert() {
  console.log('=== UPLOADING BUILD 54 (64-bit arm64-v8a) TO SUPABASE ===');
  
  const apkPath = path.join(__dirname, '..', 'FarmaCompareV-1.0.0+54.apk');
  const bucketName = 'apk';
  const remoteFileName = 'farmacompare-v1.0.0-build54.apk';
    ...
    .insert([
      {
        ...
        version_name: '1.0.0',
        apk_url: publicUrl,
        release_notes: 'v1.0.0 (Build 54): Optimización del rendimiento. Se incrementó el tiempo de caché de base de datos de 24 horas a 72 horas para acelerar las búsquedas recurrentes y reducir la latencia de red de los usuarios.',
        force_update: false
      }
    ])
    .select();
